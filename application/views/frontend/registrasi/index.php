...
<html lang="en">
  <head>
    ...
    <title><?php echo "Halaman ". $title; ?></title>
  ...
  <body class="text-center"  style="background-image: url('assets/img/logo2.jpg');">
     ...
     <?php echo form_open('Login/saves_ad','class="form-signin"');?>
     <!-- <img class="mb-4" src="<?php //echo base_url('assets/arc/img/7.jpg'); ?>" alt="" width="72" height="72"> -->
      ...
      <?php echo $this->session->flashdata('pesan'); ?>
        ...
        <br>
        <a style="color: black;" class="small" href="<?php echo base_url('L'); ?>">Login</a>
      <p class="mt-5 mb-3 text-muted"><b style="color: black;">SIDISU @ <?php echo date('Y'); ?></b></p>
